...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.3]{plots/square_vel_low}
    \caption{Prêdkoœæ \emph{ma³a}}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.35]{plots/square_vel_med}
    \caption{Prêdkoœæ \emph{œrednia}}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.35]{plots/square_vel_high}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{plots/time_medium}
		\caption{Pozycje liniowe x zadane i wykonane}
		
		\includegraphics[scale=0.6]{plots/time_medium_x}
		\caption{Prêdkoœci liniowe x zadane i wykonane}
		
	  \includegraphics[scale=0.6]{plots/time_medium_z}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{plots/odom_medium}
		\caption{Pozycje liniowe x zadane i wykonane}
		
		\includegraphics[scale=0.6]{plots/odom_medium_x}
		\caption{Prêdkoœci liniowe x zadane i wykonane}
		
		\includegraphics[scale=0.6]{plots/odom_medium_z}
		\caption{Prêdkoœci k¹towe zadane i wykonane}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1]{plots/conversion_low}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1]{plots/conversion_med}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=1.05]{plots/conversion_high}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{plots/velocities_odom}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/talker_odometria}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.85]{plots/wr_przekszt}
...
\begin{figure}[H]
    \centering
		\includegraphics[scale=0.7]{plots/low_comparison_2}
...
\begin{figure}[H]
    \centering
		\includegraphics[scale=0.7]{plots/med_comparison_2}
...
\begin{figure}[H]
    \centering
		\includegraphics[scale=0.7]{plots/high_comparison_2}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.2]{plots/graph_odometria2}
		\caption{Sterowanie z odometri¹ - struktura komunikacji}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.2]{plots/graph_predkoscowe2}
