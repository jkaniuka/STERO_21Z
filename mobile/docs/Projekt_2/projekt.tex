...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/global_without_inflation}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/local_without_inflation}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/local_without_inflation_with_obstacle}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/global_without_inflation_with obstacle}
    \caption{Lokalna mapa kosztów z warstw¹ static}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/global_inflation_layer}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/local_inflation_layer}
    \caption{Lokalna mapa kosztów z warstw¹ static oraz inflation}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/local_obstacle_detected_with_lidar}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/global_planner}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{plots/local_planner}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{plots/recovery_mode}
