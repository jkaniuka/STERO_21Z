...
def move_CIMP_towards_jar(velma):
    ...
    T_B_Jar_position = PyKDL.Vector(T_B_Jar.p)


    T_B_Jar_position[0] -= math.cos(T_B_Jar_angle) * distance
    T_B_Jar_position[1] -= math.sin(T_B_Jar_angle) * distance
    T_B_Jar_position[2] += 0.09       
    ...
    frame=PyKDL.Frame(rotation,T_B_Jar_position)
...
def move_CIMP_towards_table(velma):
    ...
    T_B_Jar_position[0] -= math.cos(T_B_Jar_angle) * dist
    T_B_Jar_position[1] -= math.sin(T_B_Jar_angle) * dist
    T_B_Jar_position[2] += 0.3      
